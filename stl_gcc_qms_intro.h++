...
#pragma once
#include "quickmerge_worst_case_efficient_3_5.h++"
#include <iterator>
namespace stl_gcc_qms_intro {
...
//					std::cout << "partial sort_gcc_qms_intro: " << last - first << std::endl;
				quickmerge_worst_case_efficient_3_5::sort(first, last, comp);
	...
	*/
	...
	void sort(std::vector<T> &v) {
		stl_gcc_qms_intro::sort(v.begin(), v.end(), std::less<T>());
	}
